...
//  <p id="description">normal calculater</p>


var h1 = document.createElement("h1");
h1.setAttribute("id","title");
h1.innerHTML="calculater";
document.body.append(h1);


var p = document.createElement("p");
p.setAttribute("id","description");
p.innerHTML="normal calculater";
...
var laRes = createlab("label","for","result",".")
display.append( laRes);
var  res = createin("input","type","text","id","result")
var b1 = linebreak("br")
laRes.append( res);
display.append(b1);
part.append(display);
var dis= creatediv("div","class"," dis ");


var laRes1 = createlab("label","for","result1",".")
dis.append(laRes1);

var res1 = createin("input","type","text ","id","result1");
laRes1.append(res1);
var b2 = linebreak("br");
dis.append( b2);
part.append(dis);
...
function Result() { 
   ...
   //    document.querySelector('#result1').value =num2;
